...
from upstream.qwen.account import ModelsFetchMixin, SessionLoginMixin
...
class QwenClient(UploadMixin, SessionLoginMixin, ModelsFetchMixin):
    ...
    async def generate_video(
        ...
        """图生视频：委托给 upstream.qwen.media.video.VideoService。"""
    ...
    async def synthesize_tts(
        ...
        """文本转语音：委托给 upstream.qwen.media.tts.TtsService。"""
